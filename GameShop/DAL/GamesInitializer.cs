...
namespace GameShop.DAL
{
    public class GamesInitializer : MigrateDatabaseToLatestVersion<GameContext, Configuration>
    {
        ...
        public static void SeedGamesData(GameContext context)
        {
            ...
            {
              new Game() {GameId=1,HardwareRequirementsId=1,Publisher="CDprojectRed",CategoryId=1,GamePrice=64,GameTitle="cyberpunk",DateAdded=Convert.ToDateTime("05-05-2020"),Premiere=Convert.ToDateTime("05-05-2020")},
              new Game() {GameId=2,HardwareRequirementsId=2,Publisher="safsfa",CategoryId=2,GameTitle="FIFA21",DateAdded=Convert.ToDateTime("05-05-2020"),Premiere=Convert.ToDateTime("05-05-2020")},
