...
namespace GameShop.DAL
{
    public class GamesInitializer : MigrateDatabaseToLatestVersion<GameContext, Configuration>
    {
        ...
        public static void SeedGamesData(GameContext context)
        {
            ...
            {
              new Game() {GameId=1,HardwareRequirementsId=1,Publisher="CDprojectRed",CategoryId=1,GamePrice=64,GameTitle="Cyberpunk",DateAdded=Convert.ToDateTime("05-05-2020"),Premiere=Convert.ToDateTime("05-05-2020"),ImageFileName="cyberpunk.jpg",GameDescryption = "Opis gry...",Type="RPG",Rating = 8},
              new Game() {GameId=2,HardwareRequirementsId=2,Publisher="safsfa",GamePrice = 124,CategoryId=2,GameTitle="Kingdom Come",DateAdded=Convert.ToDateTime("05-05-2020"),Premiere=Convert.ToDateTime("05-05-2020"),ImageFileName="kingdomcome.jpeg"},
              new Game() {GameId=3,HardwareRequirementsId=2,Publisher="safsfa",GamePrice = 250,CategoryId=2,GameTitle="Gothic 2",DateAdded=Convert.ToDateTime("05-05-2020"),Premiere=Convert.ToDateTime("05-05-2020"),ImageFileName="gothic.jpg"},
            };
